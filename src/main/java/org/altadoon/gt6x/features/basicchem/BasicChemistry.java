...
public class BasicChemistry extends GT6XFeature {
    ...
    protected void addRecipes() {
        ...
        for (FluidStack water : FL.waters(9000))
            RM.Bath.addRecipe1(true, 0, 128, dust.mat(MTx.P2O5, 7), FL.array(water), FL.array(MTx.H3PO4.liquid(16*U, false)));
        ...
        for (FluidStack water : FL.waters(6000))
            RM.Bath.addRecipe2(true, 0, 128, dust.mat(MTx.AlPO4, 6), dust.mat(MT.NaOH, 9), water, MTx.Na3PO4Solution.liquid(14 * U, false), dust.mat(MT.AlO3H3, 7));
        ...
        for (FluidStack water : FL.waters(375)) {
            RM.Electrolyzer.addRecipe1(true, 16, 640, OP.dustSmall.mat(MTx.NaBr, 1), FL.array(water), FL.array(MT.Br.liquid(U8, false), MT.H.gas(U8, false), MT.O.gas(U8, false)), OM.dust(MT.NaOH, 3 * U8));
            RM.Electrolyzer.addRecipe1(true, 16, 2560, OP.dust.mat(MTx.NaBr, 1), FL.array(FL.mul(water, 4)), FL.array(MT.Br.liquid(U2, false), MT.H.gas(U2, false)), OM.dust(MT.NaOH, 3 * U2));
        }
        ...
        RM.Mixer.addRecipe2(true, 16, 16, dust.mat(MT.Cu, 1), dust.mat(MT.I, 1), dust.mat(MTx.CuI, 2));
        ...
        // Haber-Bosch process
        RM.Mixer.addRecipe1(true, 64, 50, dust.mat(MTx.FeO, 0), FL.array(MT.H.gas(3*U, true), MT.N.gas(U, true)), FL.array(MT.NH3.gas(U, false)));
        RM.Mixer.addRecipe2(true, 16, 50, dust.mat(MT.Ru, 0),  dust.mat(MTx.La2O3, 0), FL.array(MT.H.gas(3*U, true), MT.N.gas(U, true)), FL.array(MT.NH3.gas(U, false)));
        ...
        // Alkali/Alkaline Earth metal salts and related chemistry
        ...
        RM.Electrolyzer.addRecipe1(true, 64, 64, ST.tag(1), FL.array(MTx.CsClSolution.liquid(8*U, true)), FL.array(MT.H.gas(U, false), MT.Cl.gas(U, false), MTx.CsOHSolution.liquid(6*U, false)));
        RM.Mixer.addRecipe0(true, 16, 32, FL.array(MTx.CsOHSolution.liquid(12*U, true), MT.CO2.gas(3*U, true)), FL.array(MT.H2O.liquid(9*U, false)), dust.mat(MTx.Cs2CO3, 6));
        ...
        // Solvay process
        RM.Mixer.addRecipe0(true, 16, 128, FL.array(MT.SaltWater.liquid(8*U, true), MT.CO2.gas(3*U, true), MT.NH3.gas(U, true)), FL.array(MTx.NH4ClSolution.liquid(5*U, false)), dust.mat(MT.NaHCO3, 6));
        ...
        RM.Bath.addRecipe1(true, 0, 64, dust.mat(MT.Ba, 1), MT.Cl.gas(2*U, true), NF, dust.mat(MTx.BaCl2, 1));
        ...
        for (FluidStack water : FL.waters(6000)) {
            RM.Bath.addRecipe2(false, 0, 256, OPx.anionXResin.mat(MT.Cl, 1), dust.mat(MT.NaOH, 3), water, MT.SaltWater.liquid(8 * U, false), OPx.anionXResin.mat(MTx.OH, 1));
            RM.Bath.addRecipe2(false, 0, 256, OPx.anionXResin.mat(MT.Cl, 1), dust.mat(MT.KOH, 3), water, MT.SaltedWater.liquid(8 * U, false), OPx.anionXResin.mat(MTx.OH, 1));
        }
        ...
        RM.Bath.addRecipe1(true , 0, 512, OPx.anionXResin.mat(MTx.SO4, 2), FL.array(MTx.KOHSolution.liquid(12*U, true)), FL.array(MTx.K2SO4Solution.liquid(10*U, false), MT.H2O.liquid(3*U, false)), OPx.anionXResin.mat(MTx.OH, 2));
        ...
        RM.Bath.addRecipe1(false, 0, 256, OPx.anionXResin.mat(MT .PO4, 3), FL.array(MTx.NaOHSolution.liquid(18*U, true)), FL.array(MTx.Na3PO4Solution.liquid(14*U, false), MT.H2O.liquid(3*U, false)), OPx.anionXResin.mat(MTx.OH, 1));
        ...
        RM.Bath.addRecipe1(true, 9, 512, OPx.cationXResin.mat(MT.Mg, 2), FL.array(MTx.ConcHCl.liquid(10*U, true)), FL.array(MTx.MgCl2Solution.liquid(6*U, false), MT.H2O.liquid(3*U, false)), OPx.cationXResin.mat(MT.H, 2));
        RM.Bath.addRecipe1(true, 9, 512, OPx.cationXResin.mat(MT.Ca, 2), FL.array(MTx.ConcHCl.liquid(10*U, true)), FL.array(MTx.CaCl2Solution.liquid(6*U, false), MT.H2O.liquid(3*U, false)), OPx.cationXResin.mat(MT.H, 2));
        ...
        RM.Bath.addRecipe1(true, 9, 1024, OPx.cationXResin.mat(MT.Hf, 4), MT.HCl.gas(8*U, true), MTx.HfCl4.liquid(5*U, false), OPx.cationXResin.mat(MT.H, 4));
        ...
        RM.Bath.addRecipe1(true, 0, 200, OPx.anionXResin.mat(MTx.OH, 1), MTx.HBr        .gas   (2 *U, true), MT.H2O.liquid(3*U, false), OPx.anionXResin.mat(MT.Br, 1));
        RM.Bath.addRecipe1(true, 0, 200, OPx.anionXResin.mat(MTx.OH, 1), MT .HCl        .gas   (2 *U, true), MT.H2O.liquid(3*U, false), OPx.anionXResin.mat(MT.Cl, 1));
        RM.Bath.addRecipe1(true, 0, 200, OPx.anionXResin.mat(MTx.OH, 1), MTx.ConcHCl    .liquid(5 *U, true), MT.H2O.liquid(6*U, false), OPx.anionXResin.mat(MT.Cl, 1));
        RM.Bath.addRecipe1(true, 0, 200, OPx.anionXResin.mat(MTx.OH, 1), MTx.DiluteHCl  .liquid(8 *U, true), MT.H2O.liquid(9*U, false), OPx.anionXResin.mat(MT.Cl, 1));
        RM.Bath.addRecipe1(true, 0, 200, OPx.anionXResin.mat(MTx.OH, 1), MT .HNO3       .liquid(5 *U, true), MT.H2O.liquid(3*U, false), OPx.anionXResin.mat(MTx.NO3, 1));
        RM.Bath.addRecipe1(true, 0, 200, OPx.anionXResin.mat(MTx.OH, 2), MT .H2SO4      .liquid(7 *U, true), MT.H2O.liquid(6*U, false), OPx.anionXResin.mat(MTx.SO4, 2));
        RM.Bath.addRecipe1(true, 0, 200, OPx.anionXResin.mat(MTx.OH, 2), MTx.DiluteH2SO4.liquid(10*U, true), MT.H2O.liquid(9*U, false), OPx.anionXResin.mat(MTx.SO4, 2));
        RM.Bath.addRecipe1(true, 0, 200, OPx.anionXResin.mat(MTx.OH, 3), MTx.H3PO4      .liquid(8 *U, true), MT.H2O.liquid(9*U, false), OPx.anionXResin.mat(MT.PO4, 3));

        // Triflates
        RM.Mixer.addRecipe1(true, 16, 64, dust.mat(MT.KSO4, 0), FL.array(MT.CH4.gas(U, true), MT.H2S2O7.liquid(11*U, true)), FL.array(MTx.MethanesulfonicAcid.liquid(U, false), MT.H2SO4.liquid(7*U, false)));
        RM.Electrolyzer.addRecipe1(true, 16, 128, ST.tag(2), FL.array(MTx.MethanesulfonicAcid.liquid(U, true), MT.HF.gas(6*U, true)), FL.array(MTx.TriflicAcid.liquid(U, false), MT.H.gas(6*U, false)));
        RM.Mixer.addRecipe1(true, 16, 64, dust.mat(MTx.Sc2O3, 1), MTx.TriflicAcid.liquid(3*U, true), MT.H2O.liquid(9*U2, false), dust.mat(MTx.ScandiumTriflate, 1));
    }
    ...
    private void addSolutionRecipes() {
        for (OreDictMaterial material : OreDictMaterial.MATERIAL_MAP.values()) if (material.contains(MTx.SIMPLE_SOLUTION)) {
            ...
            for (OreDictMaterialStack stack : material.mComponents.getUndividedComponents()) {
                if (stack.mMaterial.mID == MT.H2O.mID || stack.mMaterial.mID == MT.DistWater.mID) waterStack = stack;
                else soluteStack = stack;
            }
            if (waterStack == null || soluteStack == null) {
                throw new RuntimeException("Invalid solution: " + material.mNameInternal + (waterStack == null ? ", no water" : ", no solute"));
            }
            ...
            if (totalAmount != material.mComponents.getCommonDivider()) {
                throw new RuntimeException("Invalid solution: " + material.mNameInternal + ", water + solute: " + totalAmount + ", divider: " + material.mComponents.getCommonDivider());
            }

            for (FluidStack water : FL.waters(waterAmount * 1000))
                RM.Mixer.addRecipe2(true, 16, 64 * waterAmount, ST.tag(0), dust.mat(soluteStack.mMaterial, soluteAmount), water, material.liquid(totalAmount * U, false), NI);
