...
public class BasicChemistry extends GT6XFeature {
    ...
    protected void addRecipes() {
        ...
        RM.Drying.addRecipe1(true, 16, 12000, dust.mat(MTx.NH4NO3, 6), NF, FL.array(FL.DistW.make(6000), MT.N.gas(2*U, false), MT.O.gas(U, false)));
        RM.Drying.addRecipe1(true, 16, 12000, dust.mat(MTx.NH4SO4, 15), NF, FL.array(FL.DistW.make(6000), MT.N.gas(U, false), MT.NH3.gas(U, false), MT.SO2.gas(3*U, false)));
