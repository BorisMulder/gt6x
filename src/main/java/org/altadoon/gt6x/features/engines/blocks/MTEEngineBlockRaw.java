...
public class MTEEngineBlockRaw extends TileEntityBase09FacingSingle {
	...
	protected ITexture getRotatedFlippedTexture(int idx, byte side1, byte side2) {
		IIconContainer baseIcon = new IconRotated.RotatableIconContainer(baseIcons[idx], ROLL_INDEXES[side1][side2], false, false);
		IIconContainer overlayIcon = new IconRotated.RotatableIconContainer(overlayIcons[idx], ROLL_INDEXES[side1][side2], false, false);
