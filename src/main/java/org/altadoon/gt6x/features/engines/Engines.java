...
public class Engines extends GT6XFeature {
    ...
    private void addMTEs() {
        ...
        mat = MTx.Ti6Al4V;       reg.add("Dense Ti6Al4V Wall"                   , category, IDs.DenseWallTi6Al4V  .get(), 17101, MultiTileEntityMultiBlockPart  .class, mat.mToolQuality, 64, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,   9.0F, NBT_RESISTANCE,   9.0F, NBT_TEXTURE, "metalwalldense", NBT_DESIGNS, 7)); OM.data(reg.getItem(), mat, U*36); RM.Welder.addRecipe2(F, 64, 512, OP.plateDense.mat(mat, 4), ST.tag(10), reg.getItem());
                                 reg.add("Ti6Al4V Gas Turbine Main Housing"     , category, IDs.GasTurbine3       .get(), 17101, MultiTileEntityLargeTurbineGasX.class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,   9.0F, NBT_RESISTANCE,   9.0F, NBT_TEXTURE, "gasturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6xMTERegId, NBT_DESIGN, IDs.DenseWallTi6Al4V  .get(), NBT_INPUT,  12288, NBT_OUTPUT,   8192, NBT_WASTE_ENERGY, F, NBT_LIMIT_CONSUMPTION, T, NBT_ENERGY_ACCEPTED, TD.Energy.HU, NBT_ENERGY_EMITTED, TD.Energy.RU, NBT_FUELMAP, FM.Gas), "RPR", "RMS", "RCR", 'R', tbcCoatedRotor.dat(MTx.Ti6Al4V    ), 'S', OP.stickLong.dat(MTx.Ti6Al4V    ), 'P', ILx.SparkPlugs, 'C', catalyticConverter.dat(MT.Rh), 'M', reg.getItem());
        ...
        mat = MTx.TMS196;        reg.add("Dense TMS-196 Wall"                   , category, IDs.DenseWallTMS196   .get(), 17101, MultiTileEntityMultiBlockPart  .class, mat.mToolQuality, 64, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,  12.5F, NBT_RESISTANCE,  12.5F, NBT_TEXTURE, "metalwalldense", NBT_DESIGNS, 7)); OM.data(reg.getItem(), mat, U*36); RM.Welder.addRecipe2(F, 64, 512, OP.plateDense.mat(mat, 4), ST.tag(10), reg.getItem());
                                 reg.add("TMS-196 Gas Turbine Main Housing"     , category, IDs.GasTurbine4       .get(), 17101, MultiTileEntityLargeTurbineGasX.class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,  12.5F, NBT_RESISTANCE,  12.5F, NBT_TEXTURE, "gasturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6xMTERegId, NBT_DESIGN, IDs.DenseWallTMS196   .get(), NBT_INPUT,  24576, NBT_OUTPUT,  16384, NBT_WASTE_ENERGY, F, NBT_LIMIT_CONSUMPTION, T, NBT_ENERGY_ACCEPTED, TD.Energy.HU, NBT_ENERGY_EMITTED, TD.Energy.RU, NBT_FUELMAP, FM.Gas), "RPR", "RMS", "RCR", 'R', tbcCoatedRotor.dat(MTx.TMS196     ), 'S', OP.stickLong.dat(MTx.TMS196     ), 'P', ILx.SparkPlugs, 'C', catalyticConverter.dat(MT.Rh), 'M', reg.getItem());

        mat = MT.Ad;             reg.add("Vibramantium Gas Turbine Main Housing", category, IDs.GasTurbine5       .get(), 17101, MultiTileEntityLargeTurbineGasX.class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS, 100.0F, NBT_RESISTANCE, 100.0F, NBT_TEXTURE, "gasturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6MTERegId , NBT_DESIGN, 18025                       , NBT_INPUT, 196608, NBT_OUTPUT, 131072, NBT_WASTE_ENERGY, F, NBT_LIMIT_CONSUMPTION, T, NBT_ENERGY_ACCEPTED, TD.Energy.HU, NBT_ENERGY_EMITTED, TD.Energy.RU, NBT_FUELMAP, FM.Gas), "RPR", "RMS", "RCR", 'R', tbcCoatedRotor.dat(MT.Vibramantium), 'S', OP.stickLong.dat(MT.Vibramantium), 'P', ILx.SparkPlugs, 'C', catalyticConverter.dat(MT.Rh), 'M', gt6Registry.getItem(18025));

        CrucibleUtils.addSpecialMolds(MTEMoldEngineBlock.class, "Basin", MTEx.IDs.EngineBlockMolds.get(), ILx.Ceramic_Engine_Block_Mold_Raw, ILx.Ceramic_Engine_Block_Mold, "PPP", "P P", "hPy", 'P');

        MultiTileEntityPipeFluid.addFluidPipes(MTEx.IDs.PipesCastIron .get(), 26142, 200, true, false, false, false, true, false, true, true, MTEx.gt6xMTEReg, MTEx.MachineBlock, MultiTileEntityPipeFluid.class, MT.IronCast);
