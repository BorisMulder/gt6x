...
public class Engines extends GT6XFeature {
    ...
    private void addRecipes() {
        ...
        RM.Mixer.addRecipeX(true, 16, 500, ST.array(ST.tag(10), dust.mat(MTx.ZrOCl2, 40), dust.mat(MTx.Y2O3 , 2 )), FL.array(FL.DistW.make(126000), MTx.ConcHCl.liquid(10*U, true), MT.NH3.gas(22*U, true)), FL.array(MTx.NH4ClSolution.liquid(4*22*U, false)), dust.mat(MTx.YZrOH, 30));
