...
public class Engines extends GT6XFeature {
	...
	private void addMTEs() {
		...
		// SC Steam turbines
		mat = MT.StainlessSteel; reg.add("Magnalium Supercritical Steam Turbine Main Housing"   , category, IDs.SCSteamTurbine1.get(), 17101, MTELargeTurbineSteamSC.class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,   6.0F, NBT_RESISTANCE,   6.0F, NBT_TEXTURE, "largeturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6MTERegId , NBT_DESIGN, 18022                       , NBT_INPUT,   3072, NBT_OUTPUT,   2048, NBT_WASTE_ENERGY, true, NBT_ENERGY_ACCEPTED, RMx.STEAM_SC, NBT_ENERGY_EMITTED, TD.Energy.RU), "RSR", "RMR", "RSR", 'R', tbcCoatedRotor.dat(MT .Magnalium  ), 'S', OP.stickLong.dat(MT .Magnalium  ), 'M', gt6MTEReg.getItem(18022));
		mat = MTx.Hastelloy;     reg.add("Hastelloy Supercritical Steam Turbine Main Housing"   , category, IDs.SCSteamTurbine2.get(), 17101, MTELargeTurbineSteamSC.class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,   9.0F, NBT_RESISTANCE,   9.0F, NBT_TEXTURE, "largeturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6xMTERegId, NBT_DESIGN, IDs.DenseWallHastelloy.get(), NBT_INPUT,   6144, NBT_OUTPUT,   4096, NBT_WASTE_ENERGY, true, NBT_ENERGY_ACCEPTED, RMx.STEAM_SC, NBT_ENERGY_EMITTED, TD.Energy.RU), "RSR", "RMR", "RSR", 'R', tbcCoatedRotor.dat(MTx.Hastelloy  ), 'S', OP.stickLong.dat(MTx.Hastelloy  ), 'M', gt6xMTEReg.getItem(IDs.DenseWallHastelloy.get()));
		mat = MTx.Ti6Al4V;       reg.add("Ti6Al4V Supercritical Steam Turbine Main Housing"     , category, IDs.SCSteamTurbine3.get(), 17101, MTELargeTurbineSteamSC.class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,   9.0F, NBT_RESISTANCE,   9.0F, NBT_TEXTURE, "largeturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6xMTERegId, NBT_DESIGN, IDs.DenseWallTi6Al4V  .get(), NBT_INPUT,  12288, NBT_OUTPUT,   8192, NBT_WASTE_ENERGY, true, NBT_ENERGY_ACCEPTED, RMx.STEAM_SC, NBT_ENERGY_EMITTED, TD.Energy.RU), "RSR", "RMR", "RSR", 'R', tbcCoatedRotor.dat(MTx.Ti6Al4V    ), 'S', OP.stickLong.dat(MTx.Ti6Al4V    ), 'M', reg.getItem());
		mat = MTx.TMS196;        reg.add("TMS-196 Supercritical Steam Turbine Main Housing"     , category, IDs.SCSteamTurbine4.get(), 17101, MTELargeTurbineSteamSC.class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,  12.5F, NBT_RESISTANCE,  12.5F, NBT_TEXTURE, "largeturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6xMTERegId, NBT_DESIGN, IDs.DenseWallTMS196   .get(), NBT_INPUT,  24576, NBT_OUTPUT,  16384, NBT_WASTE_ENERGY, true, NBT_ENERGY_ACCEPTED, RMx.STEAM_SC, NBT_ENERGY_EMITTED, TD.Energy.RU), "RSR", "RMR", "RSR", 'R', tbcCoatedRotor.dat(MTx.TMS196     ), 'S', OP.stickLong.dat(MTx.TMS196     ), 'M', reg.getItem());
		mat = MT.Ad;             reg.add("Vibramantium Supercritical Steam Turbine Main Housing", category, IDs.SCSteamTurbine5.get(), 17101, MTELargeTurbineSteamSC.class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS, 100.0F, NBT_RESISTANCE, 100.0F, NBT_TEXTURE, "largeturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6MTERegId , NBT_DESIGN, 18025                       , NBT_INPUT, 196608, NBT_OUTPUT, 131072, NBT_WASTE_ENERGY, true, NBT_ENERGY_ACCEPTED, RMx.STEAM_SC, NBT_ENERGY_EMITTED, TD.Energy.RU), "RSR", "RMR", "RSR", 'R', tbcCoatedRotor.dat(MT.Vibramantium), 'S', OP.stickLong.dat(MT.Vibramantium), 'M', gt6MTEReg.getItem(18025));

		// Gas turbines
		mat = MT.StainlessSteel; reg.add("Magnalium Gas Turbine Main Housing"                   , category, IDs.GasTurbine1    .get(), 17101, MTELargeTurbineGasX   .class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,   6.0F, NBT_RESISTANCE,   6.0F, NBT_TEXTURE, "gasturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6MTERegId , NBT_DESIGN, 18022                       , NBT_INPUT,   3072, NBT_OUTPUT,   2048, NBT_WASTE_ENERGY, false, NBT_LIMIT_CONSUMPTION, true, NBT_ENERGY_ACCEPTED, TD.Energy.HU, NBT_ENERGY_EMITTED, TD.Energy.RU, NBT_FUELMAP, FM.Gas), "RPR", "RMS", "RCR", 'R', tbcCoatedRotor.dat(MT .Magnalium  ), 'S', OP.stickLong.dat(MT .Magnalium  ), 'P', ILx.SparkPlugs, 'C', catalyticConverter.dat(MT.Rh), 'M', gt6MTEReg.getItem(18022));
		mat = MTx.Hastelloy;     reg.add("Hastelloy Gas Turbine Main Housing"                   , category, IDs.GasTurbine2    .get(), 17101, MTELargeTurbineGasX   .class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,   9.0F, NBT_RESISTANCE,   9.0F, NBT_TEXTURE, "gasturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6xMTERegId, NBT_DESIGN, IDs.DenseWallHastelloy.get(), NBT_INPUT,   6144, NBT_OUTPUT,   4096, NBT_WASTE_ENERGY, false, NBT_LIMIT_CONSUMPTION, true, NBT_ENERGY_ACCEPTED, TD.Energy.HU, NBT_ENERGY_EMITTED, TD.Energy.RU, NBT_FUELMAP, FM.Gas), "RPR", "RMS", "RCR", 'R', tbcCoatedRotor.dat(MTx.Hastelloy  ), 'S', OP.stickLong.dat(MTx.Hastelloy  ), 'P', ILx.SparkPlugs, 'C', catalyticConverter.dat(MT.Rh), 'M', gt6xMTEReg.getItem(IDs.DenseWallHastelloy.get()));
		mat = MTx.Ti6Al4V;       reg.add("Ti6Al4V Gas Turbine Main Housing"                     , category, IDs.GasTurbine3    .get(), 17101, MTELargeTurbineGasX   .class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,   9.0F, NBT_RESISTANCE,   9.0F, NBT_TEXTURE, "gasturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6xMTERegId, NBT_DESIGN, IDs.DenseWallTi6Al4V  .get(), NBT_INPUT,  12288, NBT_OUTPUT,   8192, NBT_WASTE_ENERGY, false, NBT_LIMIT_CONSUMPTION, true, NBT_ENERGY_ACCEPTED, TD.Energy.HU, NBT_ENERGY_EMITTED, TD.Energy.RU, NBT_FUELMAP, FM.Gas), "RPR", "RMS", "RCR", 'R', tbcCoatedRotor.dat(MTx.Ti6Al4V    ), 'S', OP.stickLong.dat(MTx.Ti6Al4V    ), 'P', ILx.SparkPlugs, 'C', catalyticConverter.dat(MT.Rh), 'M', reg.getItem());
		mat = MTx.TMS196;        reg.add("TMS-196 Gas Turbine Main Housing"                     , category, IDs.GasTurbine4    .get(), 17101, MTELargeTurbineGasX   .class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS,  12.5F, NBT_RESISTANCE,  12.5F, NBT_TEXTURE, "gasturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6xMTERegId, NBT_DESIGN, IDs.DenseWallTMS196   .get(), NBT_INPUT,  24576, NBT_OUTPUT,  16384, NBT_WASTE_ENERGY, false, NBT_LIMIT_CONSUMPTION, true, NBT_ENERGY_ACCEPTED, TD.Energy.HU, NBT_ENERGY_EMITTED, TD.Energy.RU, NBT_FUELMAP, FM.Gas), "RPR", "RMS", "RCR", 'R', tbcCoatedRotor.dat(MTx.TMS196     ), 'S', OP.stickLong.dat(MTx.TMS196     ), 'P', ILx.SparkPlugs, 'C', catalyticConverter.dat(MT.Rh), 'M', reg.getItem());
		mat = MT.Ad;             reg.add("Vibramantium Gas Turbine Main Housing"                , category, IDs.GasTurbine5    .get(), 17101, MTELargeTurbineGasX   .class, mat.mToolQuality, 16, MTEx.MachineBlock, UT.NBT.make(NBT_MATERIAL, mat, NBT_HARDNESS, 100.0F, NBT_RESISTANCE, 100.0F, NBT_TEXTURE, "gasturbine", NBT_MTE_MULTIBLOCK_PART_REG, gt6MTERegId , NBT_DESIGN, 18025                       , NBT_INPUT, 196608, NBT_OUTPUT, 131072, NBT_WASTE_ENERGY, false, NBT_LIMIT_CONSUMPTION, true, NBT_ENERGY_ACCEPTED, TD.Energy.HU, NBT_ENERGY_EMITTED, TD.Energy.RU, NBT_FUELMAP, FM.Gas), "RPR", "RMS", "RCR", 'R', tbcCoatedRotor.dat(MT.Vibramantium), 'S', OP.stickLong.dat(MT.Vibramantium), 'P', ILx.SparkPlugs, 'C', catalyticConverter.dat(MT.Rh), 'M', gt6MTEReg.getItem(18025));
	...
	private void addRecipes() {
		...
		for (FluidStack water : FL.waters(3000)) {
			...
			RM.Mixer.addRecipeX(true, 16, 500, ST.array(ST.tag(10), dust.mat(MTx.ZrOCl2, 40), dust.mat(MTx.Y2O3, 2)), FL.array(FL.mul(water, 42), MTx.ConcHCl.liquid(10 * U, true), MT.NH3.gas(22 * U, true)), FL.array(MTx.NH4ClSolution.liquid(4 * 22 * U, false)), dust.mat(MTx.YZrOH, 30));
