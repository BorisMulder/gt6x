...
public class Metallurgy extends GT6XFeature {
    ...
    private void addRecipes() {
        ...
        //TODO fix
        RM.Mixer.addRecipe2(false, 16, 128, ST.tag(4), dust.mat(MTx.MoO3, 4*U), FL.array(MT.H.gas(6*U, true)), FL.array(MT.H2O.liquid(9*U, false)), dust.mat(MT.Mo, U));
        ...
        if (complexChromiumRefining) {
            ...
            for (FluidStack tWater : FL.waters(3000)) {
                ...
                RM.Bath.addRecipe1(true, 0, 64, dust.mat(MTx.Na2CO3Cr2O3Mixture, 11), tWater, MTx.Na2CO3Solution.liquid(9*U, false), dust.mat(MTx.Cr2O3, 5));
            }
            ...
            for (ItemStack coal : new ItemStack[]{dust.mat(MT.Charcoal, 1), dust.mat(MT.LigniteCoke, 3), dust.mat(MT.CoalCoke, 1), dust.mat(MT.C, 1)}) {
                RM.BurnMixer.addRecipe2(true, 16, 64, ST.mul(2, coal), dust.mat(MTx.Na2Cr2O7, 11), ZL_FS, MT.CO.gas(2*U, false), dust.mat(MTx.Na2CO3Cr2O3Mixture, 11));
            }
    ...
    private void changeRecipes() {
        ...
        //TODO remove Pig Iron from Generifier
