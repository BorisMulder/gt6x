...
public class MultiItemsElectronics extends MultiItemRandom {
    ...
    public void addItems() {
        ...
        ILx.SolarWafers[1][1].set(addItem(721, "Solar Wafer (mono-Si, textured)" , "Needs doping", new OreDictItemData(MTx.PDopedSi, 9*U10)));
        ILx.SolarWafers[1][2].set(addItem(722, "Solar Wafer (mono-Si, doped)"    , "Needs ARC (Anti-Reflective Coating)", new OreDictItemData(MTx.PDopedSi, 8*U10, MTx.NDopedSi, U10)));
        ILx.SolarWafers[1][3].set(addItem(723, "Solar Wafer (mono-Si)"           , "Needs metal contacts", new OreDictItemData(MTx.PDopedSi, 8*U10, MTx.NDopedSi, U10, MTx.Si3N4, 14*U100)));
