...
public class REEProcessing  extends GT6XFeature {
    ...
    private void addRecipes() {
        ...
        RM.Bath.addRecipe1(true, 0, 200, dust.mat(MTx.REORoasted, 5), MTx.ConcHCl.liquid(30*U, true), MTx.REECl3Solution.liquid(32*U, false), dust.mat(MTx.CeO2, 3));
        ...
        RM.Bath.addRecipe1(true, 0, 600, dust.mat(MTx.REEHydroxide, 35), FL.array(MTx.ConcHCl.liquid(60*U, true)), FL.array(MTx.REECl3Solution.liquid(64*U, false), MT.H2O.liquid(9*3*U, false)), dust.mat(MTx.ThO2, 3)); // + 1 H from Th oxidation
        ...
        // IX of REE
        //TODO fix H2O ratio
        RM.Bath.addRecipe2(true, 0, 256, dust.mat(MTx.EDTA, 1), OPx.anionXResin.mat(MTx.OH, 1), MTx.REECl3Solution.liquid(16*U, true), MTx.DiluteHCl.liquid(24*U, false), OPx.anionXResin.mat(MTx.REEEDTA, 1));
        // Y, Eu, Nd, Ce, La
    }
}
