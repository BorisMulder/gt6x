...
public class RMx {
    ...
    public static void init() {
        ...
        IonBombardment   = new RecipeMap(null, "gt6x.recipe.ionbombardment"  , "Ion Acceleration"        , null, 0, 1, RES_PATH_GUI+"machines/IonBombardment"  , 2, 1, 1, 1, 2, 0, 2, 1, "", 1, "", true, true, true, true, false, true, true);
